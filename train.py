...
def parse_args():
    ...
    parser.add_argument('--work-dir', help='the dir to save logs and models',default = 'freespace_1016')
    ...
    parser.add_argument('--no-validate', type=bool,default = True,help='whether not to evaluate the checkpoint during training')
